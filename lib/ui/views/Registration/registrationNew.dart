...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> registerUser() async {
    ...
    if (agreePassenger){
      ...
      UserModel user = UserModel(userID : 0,email: emailController.text.trim(), firstName: firstNameController.text.trim(), lastName: lastNameController.text.trim(), pathImage: pathImage, password: passwordController.text.trim(), role: role, biography: biographyController.text.trim());
